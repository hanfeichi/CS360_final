			...
			<div>
				<div>
						...
						<fieldset>
							...
							<label>Product Price：</label><input id="priceInput" type="text" name=""><br>
							<label>Tax Fee：</label><input id="fee" type="text" value=""  name=""><br>
							<label>Total：</label><input id="total" type="text" name="total_price"><br>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\register\resources\views/details.blade.php ENDPATH**/ ?>