                    ...
                    <?php $__currentLoopData = $goodsSpec; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e($g['spec_name']); ?> : <br>
                            <?php $__currentLoopData = $GoodsSpecSku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <input type="checkbox" name="GoodsSpecSku_id[]"  <?php if($skuid_array): ?><?php if(in_array($s["id"],$skuid_array)): ?> checked <?php endif; ?> <?php endif; ?>   value=" <?php echo e($s['id']); ?>"> <?php echo e($s['sku_name']); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\70725\Desktop\register\resources\views/home.blade.php ENDPATH**/ ?>